...
public class PruebaEjemplo {
    ...
    public static void main(String[] args) {
        ...
        Cuentahabiente usuario1 = new Cuentahabiente("PUCHIS", 422938540, 50000);
        Cuentahabiente usuario2 = new Cuentahabiente("topola", 122222222, 20000);
        Cuentahabiente usuario3 = new Cuentahabiente("willy", 19191911, 30000);
      ...
      lista[0] =new Cuentahabiente("Elias", 34321111, 70000 );  
        
      lista[1] =new Cuentahabiente("TOPO", 0201010101, 12000); 
